...
# PRETRAINED_ON="sbdh_gpt4_hr+"
MODEL_PATH="./saved_models/climamba_${PRETRAINED_ON}_0/"
...
for SEED in "${SEEDS[@]}"
    ...
    # WANDB_MODE=disabled  
    CUDA_VISIBLE_DEVICES=7 python main_mamba.py \
                ...
                --run_name climamba_frm_${PRETRAINED_ON}_ml_${DATASET}_${SEED}\
                --output_dir ./saved_models/climamba_frm_${PRETRAINED_ON}_${DATASET}_${SEED}  2>&1 | tee ./stdout/stdout_climamba_frm_${PRETRAINED_ON}_${DATASET}_${SEED}.txt
    done
...
#                 --output_dir ./saved_models/climamba_${DATASET}_${SEED}  2>&1 | tee ./stdout/stdout_climamba_${DATASET}_${SEED}_inf.txt
#     done
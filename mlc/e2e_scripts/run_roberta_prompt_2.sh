...
for SEED in "${SEEDS[@]}"
    ...
    CUDA_VISIBLE_DEVICES=1 python main_roberta_prompt.py \
                    ...
                    --run_name roberta_prompt_frm_sbdh_gpt4_msf_v3_ml_${DATASET}_${SEED}\
                    --output_dir ./saved_models/roberta_prompt_frm_sbdh_gpt4_msf_v3_${DATASET}_${SEED} 2>&1 | tee /home/avijit/playground/sdoh/stdout/stdout_roberta_prompt_frm_sbdh_gpt4_msf_v3_${DATASET}_${SEED}.txt
    done
...
#                     --output_dir ./saved_models/roberta_prompt_frm_sbdh_gpt4_msf_${DATASET}_${SEED} 2>&1 | tee /home/avijit/playground/sdoh/stdout/stdout_roberta_prompt_frm_sbdh_gpt4_msf_${DATASET}_${SEED}_inf.txt
#     done
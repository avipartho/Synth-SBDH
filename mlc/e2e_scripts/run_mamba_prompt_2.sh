...
# +-------------------------------------------------+
# MODEL_PATH="./saved_models/mamba_prompt_0/checkpoint-397"

# MODEL_PATH="./saved_models/mamba_prompt_sbdh_gpt4_v2_0/checkpoint-912"

# MODEL_PATH="./saved_models/mamba_prompt_sbdh_gpt4_msf_v3_0/checkpoint-420"

PRETRAINED_ON="sbdh_gpt4_hr"
# PRETRAINED_ON="sbdh_gpt4_hr+"
MODEL_PATH="./saved_models/mamba_prompt_${PRETRAINED_ON}_0/"
...
for SEED in "${SEEDS[@]}"
    ...
    # WANDB_MODE=disabled  
    CUDA_VISIBLE_DEVICES=6 python main_mamba_prompt.py \
                ...
                --run_name mamba_prompt_frm_${PRETRAINED_ON}_ml_${DATASET}_${SEED}\
                --output_dir ./saved_models/mamba_prompt_frm_${PRETRAINED_ON}_${DATASET}_${SEED}  2>&1 | tee ./stdout/stdout_mamba_prompt_frm_${PRETRAINED_ON}_${DATASET}_${SEED}.txt
    done

# for SEED in "${SEEDS[@]}"
#     do
#     echo "######### Seed:" ${SEED} "#########"
#     WANDB_MODE=disabled  CUDA_VISIBLE_DEVICES=0 python main_mamba_prompt.py \
#                 --seed ${SEED} --data_seed ${SEED} --ddp_find_unused_parameters False\
...
#                 --overwrite_output_dir True \
#                 --load_best_model_at_end --metric_for_best_model eval_f1_macro --greater_is_better True --save_total_limit 2 \
#                 --run_name mamba_prompt_ml_${SEED}\
#                 --output_dir ./saved_models/mamba_prompt_${SEED}  2>&1 | tee ./stdout/stdout_mamba_prompt_${SEED}_inf.txt
#     done

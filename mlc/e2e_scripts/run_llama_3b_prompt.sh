...
for SEED in "${SEEDS[@]}"
    ...
    CUDA_VISIBLE_DEVICES=0 python main_llama_prompt.py \
                    ...
                    --run_name llama_3b_prompt_ml_${DATASET}_${SEED}\
                    --output_dir ./saved_models/llama_3b_prompt_${DATASET}_${SEED} 2>&1 | tee ./stdout/stdout_llama_3b_prompt_${DATASET}_${SEED}.txt
    done

...
for SEED in "${SEEDS[@]}"
    ...
    # WANDB_MODE=disabled  
    CUDA_VISIBLE_DEVICES=1 python main_mamba_prompt.py \
                ...
                --run_name mamba_prompt_ml_${DATASET}_${SEED}\
                --output_dir ./saved_models/mamba_prompt_${DATASET}_${SEED}  2>&1 | tee /home/avijit/playground/sdoh/stdout/stdout_mamba_prompt_${DATASET}_${SEED}.txt
    done

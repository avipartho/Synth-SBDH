...
for SEED in "${SEEDS[@]}"
    ...
    CUDA_VISIBLE_DEVICES=0 python main_mamba_prompt.py \
                ...
                --run_name mamba_prompt_frm_sbdh_gpt4_msf_v3_ml_${DATASET}_${SEED}\
                --output_dir ./saved_models/mamba_prompt_frm_sbdh_gpt4_msf_v3_${DATASET}_${SEED}  2>&1 | tee /home/avijit/playground/sdoh/stdout/stdout_mamba_prompt_frm_sbdh_gpt4_msf_v3_${DATASET}_${SEED}.txt
    done
...
#                 --output_dir ./saved_models/mamba_prompt_${SEED}  2>&1 | tee /home/avijit/playground/sdoh/stdout/stdout_mamba_prompt_${SEED}_inf.txt
#     done

...
for SEED in "${SEEDS[@]}"
    ...
    # WANDB_MODE=disabled  
    CUDA_VISIBLE_DEVICES=0 python main_roberta_prompt.py \
                    ...
                    --output_dir ./saved_models/cliroberta_prompt_${DATASET}_${SEED} 2>&1 | tee /home/avijit/playground/sdoh/stdout/stdout_cliroberta_prompt_${DATASET}_${SEED}.txt
    done

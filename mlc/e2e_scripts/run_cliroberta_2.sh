...
for SEED in "${SEEDS[@]}"
    ...
    # WANDB_MODE=disabled 
    CUDA_VISIBLE_DEVICES=2 python main_roberta.py \
                    ...
                    --run_name cliroberta_frm_sbdh_gpt4_msf_v3_ml_${DATASET}_${SEED}\
                    --output_dir ./saved_models/cliroberta_frm_sbdh_gpt4_msf_v3_${DATASET}_${SEED} 2>&1 | tee /home/avijit/playground/sdoh/stdout/stdout_cliroberta_frm_sbdh_gpt4_msf_v3_${DATASET}_${SEED}.txt
    done
...
#                     --output_dir ./saved_models/cliroberta_${DATASET}_${SEED} 2>&1 | tee /home/avijit/playground/sdoh/stdout/stdout_cliroberta_${SEED}_inf.txt
#     done
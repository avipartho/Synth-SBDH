...
# PRETRAINED_ON="sbdh_gpt4_hr+"
MODEL_PATH="./saved_models/roberta_${PRETRAINED_ON}_0/"
...
for SEED in "${SEEDS[@]}"
    ...
    # WANDB_MODE=disabled 
    CUDA_VISIBLE_DEVICES=4 python main_roberta.py \
                    ...
                    --run_name roberta_frm_${PRETRAINED_ON}_ml_${DATASET}_${SEED}\
                    --output_dir ./saved_models/roberta_frm_${PRETRAINED_ON}_${DATASET}_${SEED} 2>&1 | tee ./stdout/stdout_roberta_frm_${PRETRAINED_ON}_${DATASET}_${SEED}.txt
    done
...
#                     --output_dir ./saved_models/roberta_${DATASET}_${SEED} 2>&1 | tee ./stdout/stdout_roberta_${SEED}_inf.txt
#     done